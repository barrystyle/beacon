...
public:
    CMainParams()
    {
        ...
        nBeaconBadBlockTime = 1471401614; // Skip nBit validation of Block 259201 per PR #915
        nBeaconBadBlocknBits = 0x1c056dac; // Skip nBit validation of Block 259201 per PR #915
