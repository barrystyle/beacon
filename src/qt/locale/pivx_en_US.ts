...
<context>
    ...
    <message>
        <source>To use beacond, or the -server option to becn-qt, you must set an rpcpassword in the configuration file:
%s
...
for example: alertnotify=echo %%s | mail -s "BECN Alert" admin@foo.com
        ...
        <translation>To use beacond, or the -server option to becn-qt, you must set an rpcpassword in the configuration file:
%s
It is recommended you use the following random password:
rpcuser=pivxrpc
rpcpassword=%s
