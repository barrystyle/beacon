                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzBECNPathCustom = GetArg("-zpivbackuppath", "");
    ...
    if(!strzBECNPathCustom.empty()) {
        ui->wallet_customzpivbackuppath->setText(QString::fromStdString(strzBECNPathCustom));
        ui->wallet_customzpivbackuppath_label->setVisible(true);
        ui->wallet_customzpivbackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzBECNPathCustom.empty()) && nCustomBackupThreshold > 0) {
